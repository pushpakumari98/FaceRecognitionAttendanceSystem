...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'pushpa20052002kumari@gmail.com' ")
...
message3 = tk.Label(window, text="Face Recognition Based Attendance Monitoring System" ,fg="white",bg="#0000aa" ,width=55 ,height=1,font=('comic', 29, ' bold '))
message3.place(x=10, y=10)

datef = tk.Label(window, text=day + "-" + mont[month] + "-" + year, fg="#e31937", bg="pink",
                 width=20, font=('comic', 15, ' bold '))
datef.pack(fill='both', expand=True)
datef.place(relx=0.30, rely=0.09)

clock = tk.Label(window, fg="#e31937", bg="pink", width=20, font=('comic', 15, ' bold '))
...
def send_email():
    ...
    from_email = "pushpa20052002kumari@gmail.com"  # Update with your email
    password = "ysyb jckx ssrq idjd"  # Update with your email password
